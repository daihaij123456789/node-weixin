...
var help = '欢迎订阅大海休闲\n' +
			...
			'回复语音,使用语音查询信息\n' +
			'点击 <a href="http://www.xuankuangren.com/voiceMovie">语音查电影</a>'+
			'点击 <a href="http://www.xuankuangren.com/voiceMusic">语音查音乐</a>';
	...
	if(message.MsgType==='event'){
			...
			if(message.EventKey === 'movie_hot'){
				...
				movies.forEach(function(movie){
					news.push({
							...
							picUrl: movie.poster,
							url: 'http://www.xuankuangren.com/wechat/jumpMovie/' + movie._id
						});
				})
				...
				musics.forEach(function(muisc,index){
						news.push({
							...
							picUrl: muisc.image,
							url: 'http://www.xuankuangren.com/wechat/jumpMusic/' + muisc._id
						});
				})
		...
		if (content === '1') {
			...
			reply = [{
				...
				url: 'http://www.xuankuangren.com/musicIndex'
			}]
		}else {
					...
					musics.forEach(function(music, index){
						if (index < 6) {
							reply.push({
								...
								picUrl: music.image,
								url: 'http://www.xuankuangren.com/wechat/jumpMusic/' + music._id
							});
						}
					})
				}else{ 
